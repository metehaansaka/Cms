  ...
  <body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
      <div class="c-sidebar-brand d-lg-down-none">
        <a href="{{ url('/','admin') }}" style="color:inherit;">
            <img src="{{ asset('assets/admin/assets/img/final-logo-example-1.png') }}" alt="Logo" class="img-fluid">
        </a>
      </div>
      <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="fas fa-tachometer-alt"></i> Sistem Yönetimi</a>
          <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('Genel Ayarlar') }}"><span class="c-sidebar-nav-icon"><i class="far fa-circle mr-0"></i></span> Genel Ayarlar</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('Bülten İstekleri') }}"><span class="c-sidebar-nav-icon"><i class="far fa-circle mr-0"></i></span> Bülten İstekleri</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('Kullanıcı Yönetimi') }}"><span class="c-sidebar-nav-icon"><i class="far fa-circle mr-0"></i></span> Kullanıcı Yönetimi</a></li>
          </ul>
        </li>

        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <i class="fab fa-wpforms"></i> Form Yönetimi</a>
          <ul class="c-sidebar-nav-dropdown-items">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('Formlar') }}"><span class="c-sidebar-nav-icon"><i class="far fa-circle mr-0"></i></span> Formlar</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('Form Alanları') }}"><span class="c-sidebar-nav-icon"><i class="far fa-circle mr-0"></i></span> Form Alanları</a></li>
          </ul>
        </li>

        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route("CMS Yönetimi",['id' => 0]) }}">
             <i class="fas fa-tasks"></i>CMS Yönetimi</a>
        </li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route("language") }}">
             <i class="fas fa-language"></i>Dil Yönetimi</a>
        </li>
        <li class="c-sidebar-nav-item" style="display:none;"><a class="c-sidebar-nav-link" href="#">
             <i class="far fa-chart-bar"></i>Raporlar</a>
        </li>
    ...
    <div class="c-wrapper c-fixed-components">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <div class="w-100 d-flex justify-content-between align-items-center">
          <div class="w-100 d-md-flex justify-content-start d-none">
          <button class="c-header-toggler c-class-toggler mfs-3 d-md-down-none" type="button" data-target="#sidebar" data-class="c-sidebar-lg-show" responsive="true">
            <svg class="c-icon c-icon-lg">
              <use xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg#cil-menu') }}"></use>
            </svg>
          </button>
          <a href="/" class="btn btn-dark" target="_blank">Anasayfa</a>
        </div>
        ...
        <div class="c-subheader px-3">
          <!-- Breadcrumb-->
          <div class="w-100 d-flex justify-content-between align-items-center">
            <div class="w-100 d-md-flex d-none justify-content-start">
              <ol class="breadcrumb border-0 m-0" style="align-items:center;">
            ...
            <div class="d-flex justify-content-center lang-section">
      ...
      <div class="c-body">
        ...
        <footer class="c-footer">
          <div><a href="" target="_blank">Deneme</a> © {{ now()->year }} Tüm Hakları Saklıdır.</div>
    ...
    $('#confirm-delete').on('show.bs.modal', function(e) {
      console.log($(e.relatedTarget).data('href') + " asd")
