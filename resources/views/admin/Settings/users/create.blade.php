...
<div class="row">
  ...
  <div class="col-md-10">
  <input class="form-control" id="text-input" type="text" name="ad-soyad" placeholder="Ad Soyad">
  </div>
  </div>
  <div class="form-group row">
  <label class="col-md-2 col-form-label" for="email-input">E-Mail</label>
  <div class="col-md-10">
  <input class="form-control" id="email-input" type="email" name="email" placeholder="ornek@gmail.com" autocomplete="email">
  </div>
  </div>
  <div class="form-group row">
